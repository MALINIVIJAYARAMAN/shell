...
sed -i -e "s/CATALOGUE_ENDPOINT/catalogue-test.devopstrainings01.tk/" -e "s/REDIS_ENDPOINT/redis-test.devopstrainings01.tk/" /home/roboshop/${COMPONENT}/systemd.service
